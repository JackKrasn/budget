...
import AccountDetailsPage from '@/pages/accounts/[id]/page'
...
import PlannedExpenseDetailsPage from '@/pages/planned-expenses/[id]/page'
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: <PlannedExpenseDetailsPage />,
      },
      {
